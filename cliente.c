...
int main(int argc, char *argv[]) {
    ...
    if (strcmp(u1.nomeUtente, "ESPECIALIDADEFULL") == 0) {
        fprintf(stdout, "Foi lhe atribuido a especialidade %s, mas esta ja se encontra cheia",
                u1.especialidadeAtribuida);
        exit(0);
    }
    ...
    do {
        ...
        if (FD_ISSET(fdCliente, &read_fds)) {
            ...
            if (readSize > 0) {
             ...
             !(strcmp(msg.msg, "SHUTDOWN") == 0 && msg.sender == pidServer));
